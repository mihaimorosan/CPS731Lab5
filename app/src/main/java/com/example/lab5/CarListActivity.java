...
public class CarListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            holder.carTitle.setText(mValues.get(position).title);
            holder.carDescription.setText(mValues.get(position).description);
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            final TextView carTitle;
            final TextView carDescription;

            ViewHolder(View view) {
                super(view);
                carTitle = (TextView) view.findViewById(R.id.car_title);
                carDescription = (TextView) view.findViewById(R.id.car_description);
            }
        }
    }
}